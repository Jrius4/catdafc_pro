...
<head>
  ...
  {{-- <link rel="stylesheet" href="{{asset('static/jquery-ui/jquery-ui.min.css')}}"> --}}
  @yield('first-scripts')
  @yield('style')
  ...
  <![endif]-->
  <link rel="shortcut icon" href="{{ asset('soccer_assets/images/catda.png')}}" type="image/x-icon">
...
<div class="wrapper">
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; {{date('Y')}} <a href="/">CATDA.F.C</a>.</strong> All rights
    reserved.
  </footer>
