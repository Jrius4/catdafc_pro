...
Route::resource('/backend/teams', 'TeamController',['as' =>'backend']);
Route::resource('/backend/players', 'PlayerController',['as' =>'backend']);
Route::resource('/backend/managers', 'ManagerController',['as' =>'backend']);
Route::resource('/backend/matches', 'SocmatchController',['as' =>'backend']);
